...
export function toServiceCIDR(input: c.JSONValue): ServiceCIDR & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "networking.k8s.io/v1alpha1", "ServiceCIDR"),
    metadata: c.readOpt(obj["metadata"], MetaV1.toObjectMeta),
...
export function fromServiceCIDR(input: ServiceCIDR): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "networking.k8s.io/v1alpha1", "ServiceCIDR"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
...
export function toServiceCIDRList(input: c.JSONValue): ServiceCIDRList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "networking.k8s.io/v1alpha1", "ServiceCIDRList"),
    metadata: MetaV1.toListMeta(obj.metadata),
