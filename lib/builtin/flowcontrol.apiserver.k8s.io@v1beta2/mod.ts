...
export class FlowcontrolApiserverV1beta2Api {
  ...
  ): Promise<FlowcontrolApiserverV1beta2.FlowSchemaList> {
  ...
  ): Promise<FlowcontrolApiserverV1beta2.FlowSchema> {
    const resp = await this.#client.performRequest({
      method: "POST",
      path: `${this.#root}flowschemas`,
      expectJson: true,
  ...
  ): Promise<FlowcontrolApiserverV1beta2.FlowSchema | MetaV1.Status> {
    const resp = await this.#client.performRequest({
      method: "DELETE",
      path: `${this.#root}flowschemas/${name}`,
      expectJson: true,
  ...
  async getPriorityLevelConfigurationList(
    opts: operations.GetListOpts = {},
  ): Promise<FlowcontrolApiserverV1beta2.PriorityLevelConfigurationList> {
    const resp = await this.#client.performRequest({
      method: "GET",
  ...
  async createPriorityLevelConfiguration(
    ...
    opts: operations.PutOpts = {},
  ): Promise<FlowcontrolApiserverV1beta2.PriorityLevelConfiguration> {
    const resp = await this.#client.performRequest({
      method: "POST",
      path: `${this.#root}prioritylevelconfigurations`,
      expectJson: true,
  ...
  async deletePriorityLevelConfiguration(
    name: string,
    opts: operations.DeleteOpts = {},
  ): Promise<FlowcontrolApiserverV1beta2.PriorityLevelConfiguration | MetaV1.Status> {
    const resp = await this.#client.performRequest({
      method: "DELETE",
      path: `${this.#root}prioritylevelconfigurations/${name}`,
      expectJson: true,
