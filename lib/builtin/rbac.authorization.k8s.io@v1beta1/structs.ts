// Autogenerated Schema file for RbacAuthorizationV1beta1
...
export function toClusterRole(input: c.JSONValue): ClusterRole & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "rbac.authorization.k8s.io/v1beta1", "ClusterRole"),
...
export function fromClusterRole(input: ClusterRole): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "rbac.authorization.k8s.io/v1beta1", "ClusterRole"),
    ...input,
...
export function toClusterRoleBinding(input: c.JSONValue): ClusterRoleBinding & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "rbac.authorization.k8s.io/v1beta1", "ClusterRoleBinding"),
    metadata: c.readOpt(obj["metadata"], MetaV1.toObjectMeta),
...
export function fromClusterRoleBinding(input: ClusterRoleBinding): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "rbac.authorization.k8s.io/v1beta1", "ClusterRoleBinding"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
...
export function toClusterRoleBindingList(input: c.JSONValue): ClusterRoleBindingList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "rbac.authorization.k8s.io/v1beta1", "ClusterRoleBindingList"),
...
export function toClusterRoleList(input: c.JSONValue): ClusterRoleList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "rbac.authorization.k8s.io/v1beta1", "ClusterRoleList"),
    metadata: MetaV1.toListMeta(obj.metadata),
...
export function toRole(input: c.JSONValue): Role & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "rbac.authorization.k8s.io/v1beta1", "Role"),
    metadata: c.readOpt(obj["metadata"], MetaV1.toObjectMeta),
    rules: c.readOpt(obj["rules"], x => c.readList(x, toPolicyRule)),
  }}
export function fromRole(input: Role): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "rbac.authorization.k8s.io/v1beta1", "Role"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
    rules: input.rules?.map(fromPolicyRule),
  }}
...
export function toRoleBinding(input: c.JSONValue): RoleBinding & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "rbac.authorization.k8s.io/v1beta1", "RoleBinding"),
    metadata: c.readOpt(obj["metadata"], MetaV1.toObjectMeta),
    roleRef: toRoleRef(obj["roleRef"]),
    subjects: c.readOpt(obj["subjects"], x => c.readList(x, toSubject)),
  }}
export function fromRoleBinding(input: RoleBinding): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "rbac.authorization.k8s.io/v1beta1", "RoleBinding"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
    roleRef: input.roleRef != null ? fromRoleRef(input.roleRef) : undefined,
    subjects: input.subjects?.map(fromSubject),
...
export function toRoleBindingList(input: c.JSONValue): RoleBindingList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "rbac.authorization.k8s.io/v1beta1", "RoleBindingList"),
    metadata: MetaV1.toListMeta(obj.metadata),
...
export function toRoleList(input: c.JSONValue): RoleList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "rbac.authorization.k8s.io/v1beta1", "RoleList"),
    metadata: MetaV1.toListMeta(obj.metadata),
