// Autogenerated Schema file for NodeV1
...
export function toRuntimeClass(input: c.JSONValue): RuntimeClass & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "node.k8s.io/v1", "RuntimeClass"),
...
export function fromRuntimeClass(input: RuntimeClass): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "node.k8s.io/v1", "RuntimeClass"),
    ...input,
...
export function toRuntimeClassList(input: c.JSONValue): RuntimeClassList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "node.k8s.io/v1", "RuntimeClassList"),
