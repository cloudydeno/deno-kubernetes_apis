...
export class FlowcontrolApiserverV1Api {
  ...
  ): Promise<FlowcontrolApiserverV1.FlowSchemaList> {
  ...
  ): Promise<c.WatchEventStream<FlowcontrolApiserverV1.FlowSchema>> {
    const resp = await this.#client.performRequest({
      method: "GET",
      path: `${this.#root}flowschemas`,
      expectJson: true,
  ...
  ): Promise<FlowcontrolApiserverV1.FlowSchema | MetaV1.Status> {
    const resp = await this.#client.performRequest({
      method: "DELETE",
      path: `${this.#root}flowschemas/${name}`,
      expectJson: true,
  ...
  async getPriorityLevelConfigurationList(
    opts: operations.GetListOpts = {},
  ): Promise<FlowcontrolApiserverV1.PriorityLevelConfigurationList> {
    const resp = await this.#client.performRequest({
      method: "GET",
  ...
  async watchPriorityLevelConfigurationList(
    opts: operations.WatchListOpts = {},
  ): Promise<c.WatchEventStream<FlowcontrolApiserverV1.PriorityLevelConfiguration>> {
    const resp = await this.#client.performRequest({
      method: "GET",
      path: `${this.#root}prioritylevelconfigurations`,
      expectJson: true,
  ...
  async deletePriorityLevelConfiguration(
    name: string,
    opts: operations.DeleteOpts = {},
  ): Promise<FlowcontrolApiserverV1.PriorityLevelConfiguration | MetaV1.Status> {
    const resp = await this.#client.performRequest({
      method: "DELETE",
      path: `${this.#root}prioritylevelconfigurations/${name}`,
      expectJson: true,
