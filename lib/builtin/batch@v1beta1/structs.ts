...
export function toCronJob(input: c.JSONValue): CronJob & c.ApiKind {
  ...
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "batch/v1beta1", "CronJob"),
...
export function fromCronJob(input: CronJob): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "batch/v1beta1", "CronJob"),
    ...input,
...
export function toCronJobList(input: c.JSONValue): CronJobList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "batch/v1beta1", "CronJobList"),
