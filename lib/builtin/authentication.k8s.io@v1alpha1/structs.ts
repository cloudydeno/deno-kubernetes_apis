// Autogenerated Schema file for AuthenticationV1alpha1
...
export function toSelfSubjectReview(input: c.JSONValue): SelfSubjectReview & c.ApiKind {
  ...
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "authentication.k8s.io/v1alpha1", "SelfSubjectReview"),
...
export function fromSelfSubjectReview(input: SelfSubjectReview): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "authentication.k8s.io/v1alpha1", "SelfSubjectReview"),
    ...input,
