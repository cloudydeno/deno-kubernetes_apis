// Autogenerated Schema file for ApiextensionsV1beta1
...
export interface CustomResourceConversion {
  conversionReviewVersions?: Array<string> | null;
  strategy: string;
...
export function toCustomResourceConversion(input: c.JSONValue): CustomResourceConversion {
  const obj = c.checkObj(input);
  return {
    conversionReviewVersions: c.readOpt(obj["conversionReviewVersions"], x => c.readList(x, c.checkStr)),
    strategy: c.checkStr(obj["strategy"]),
    webhookClientConfig: c.readOpt(obj["webhookClientConfig"], toWebhookClientConfig),
  }}
export function fromCustomResourceConversion(input: CustomResourceConversion): c.JSONValue {
  return {
    ...input,
    webhookClientConfig: input.webhookClientConfig != null ? fromWebhookClientConfig(input.webhookClientConfig) : undefined,
  }}
...
export function toCustomResourceDefinition(input: c.JSONValue): CustomResourceDefinition & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "apiextensions.k8s.io/v1beta1", "CustomResourceDefinition"),
...
export function fromCustomResourceDefinition(input: CustomResourceDefinition): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "apiextensions.k8s.io/v1beta1", "CustomResourceDefinition"),
    ...input,
...
export interface CustomResourceDefinitionSpec {
  ...
  validation?: CustomResourceValidation | null;
  version?: string | null;
  versions?: Array<CustomResourceDefinitionVersion> | null;
}
export function toCustomResourceDefinitionSpec(input: c.JSONValue): CustomResourceDefinitionSpec {
  ...
  return {
    ...
    validation: c.readOpt(obj["validation"], toCustomResourceValidation),
    version: c.readOpt(obj["version"], c.checkStr),
    versions: c.readOpt(obj["versions"], x => c.readList(x, toCustomResourceDefinitionVersion)),
  }}
export function fromCustomResourceDefinitionSpec(input: CustomResourceDefinitionSpec): c.JSONValue {
  return {
    ...
    validation: input.validation != null ? fromCustomResourceValidation(input.validation) : undefined,
...
export function toCustomResourceDefinitionList(input: c.JSONValue): CustomResourceDefinitionList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "apiextensions.k8s.io/v1beta1", "CustomResourceDefinitionList"),
