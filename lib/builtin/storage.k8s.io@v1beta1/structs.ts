...
export function toCSIDriver(input: c.JSONValue): CSIDriver & c.ApiKind {
  ...
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "storage.k8s.io/v1beta1", "CSIDriver"),
    metadata: c.readOpt(obj["metadata"], MetaV1.toObjectMeta),
    spec: toCSIDriverSpec(obj["spec"]),
  }}
export function fromCSIDriver(input: CSIDriver): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "storage.k8s.io/v1beta1", "CSIDriver"),
    ...input,
...
export function toCSIDriverList(input: c.JSONValue): CSIDriverList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "storage.k8s.io/v1beta1", "CSIDriverList"),
...
export function toCSINode(input: c.JSONValue): CSINode & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "storage.k8s.io/v1beta1", "CSINode"),
    metadata: c.readOpt(obj["metadata"], MetaV1.toObjectMeta),
    spec: toCSINodeSpec(obj["spec"]),
  }}
export function fromCSINode(input: CSINode): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "storage.k8s.io/v1beta1", "CSINode"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
...
export function toCSINodeList(input: c.JSONValue): CSINodeList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "storage.k8s.io/v1beta1", "CSINodeList"),
    metadata: MetaV1.toListMeta(obj.metadata),
...
export function toStorageClass(input: c.JSONValue): StorageClass & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "storage.k8s.io/v1beta1", "StorageClass"),
...
export function fromStorageClass(input: StorageClass): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "storage.k8s.io/v1beta1", "StorageClass"),
    ...input,
...
export function toStorageClassList(input: c.JSONValue): StorageClassList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "storage.k8s.io/v1beta1", "StorageClassList"),
    metadata: MetaV1.toListMeta(obj.metadata),
...
export function toVolumeAttachment(input: c.JSONValue): VolumeAttachment & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "storage.k8s.io/v1beta1", "VolumeAttachment"),
    metadata: c.readOpt(obj["metadata"], MetaV1.toObjectMeta),
...
export function fromVolumeAttachment(input: VolumeAttachment): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "storage.k8s.io/v1beta1", "VolumeAttachment"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
...
export function toVolumeAttachmentList(input: c.JSONValue): VolumeAttachmentList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "storage.k8s.io/v1beta1", "VolumeAttachmentList"),
    metadata: MetaV1.toListMeta(obj.metadata),
