// Autogenerated Schema file for FlowcontrolApiserverV1beta3
...
export function toFlowSchema(input: c.JSONValue): FlowSchema & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "flowcontrol.apiserver.k8s.io/v1beta3", "FlowSchema"),
...
export function fromFlowSchema(input: FlowSchema): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "flowcontrol.apiserver.k8s.io/v1beta3", "FlowSchema"),
    ...input,
...
export function toFlowSchemaList(input: c.JSONValue): FlowSchemaList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "flowcontrol.apiserver.k8s.io/v1beta3", "FlowSchemaList"),
...
export function toPriorityLevelConfiguration(input: c.JSONValue): PriorityLevelConfiguration & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "flowcontrol.apiserver.k8s.io/v1beta3", "PriorityLevelConfiguration"),
    metadata: c.readOpt(obj["metadata"], MetaV1.toObjectMeta),
...
export function fromPriorityLevelConfiguration(input: PriorityLevelConfiguration): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "flowcontrol.apiserver.k8s.io/v1beta3", "PriorityLevelConfiguration"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
...
export function toPriorityLevelConfigurationList(input: c.JSONValue): PriorityLevelConfigurationList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "flowcontrol.apiserver.k8s.io/v1beta3", "PriorityLevelConfigurationList"),
    metadata: MetaV1.toListMeta(obj.metadata),
