...
import * as CertManagerIoV1alpha3 from "../cert-manager.io@v1alpha3/structs.ts";
...
export interface Challenge {
  ...
  spec?: {
    ...
    key: string;
    solver: CertManagerIoV1alpha3.SolverSpec;
    token: string;
...
export function fromChallenge(input: Challenge): c.JSONValue {
  return {
    ...
    spec: input.spec != null ? {
      ...input.spec,
      solver: input.spec.solver != null ? CertManagerIoV1alpha3.fromSolverSpec(input.spec.solver) : undefined,
    } : undefined,
  }}
export function toChallenge_spec(input: c.JSONValue) {
  ...
  return {
    ...
    solver: CertManagerIoV1alpha3.toSolverSpec(obj["solver"]),
