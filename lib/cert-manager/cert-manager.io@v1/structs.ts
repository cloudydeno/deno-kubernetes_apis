...
export function toCertificate_spec_nameConstraints(input: c.JSONValue) {
  const obj = c.checkObj(input);
  return {
...
export function toCertificate_spec_otherNames(input: c.JSONValue) {
  const obj = c.checkObj(input);
  return {
...
export function toCertificate_spec_nameConstraints_excluded(input: c.JSONValue) {
  const obj = c.checkObj(input);
  return {
...
export function toCertificate_spec_nameConstraints_permitted(input: c.JSONValue) {
  const obj = c.checkObj(input);
  return {
    dnsDomains: c.readOpt(obj["dnsDomains"], x => c.readList(x, c.checkStr)),
    emailAddresses: c.readOpt(obj["emailAddresses"], x => c.readList(x, c.checkStr)),
...
export function toSolverSpec_dns01_route53_auth(input: c.JSONValue) {
  const obj = c.checkObj(input);
  return {
...
export function toSolverSpec_dns01_route53_auth_kubernetes(input: c.JSONValue) {
  const obj = c.checkObj(input);
  return {
...
export function toSolverSpec_dns01_route53_auth_kubernetes_serviceAccountRef(input: c.JSONValue) {
  const obj = c.checkObj(input);
  return {
    audiences: c.readOpt(obj["audiences"], x => c.readList(x, c.checkStr)),
    name: c.checkStr(obj["name"]),
