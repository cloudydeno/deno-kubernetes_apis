...
import * as CertManagerIoV1beta1 from "../cert-manager.io@v1beta1/structs.ts";
...
export interface Challenge {
  ...
  spec: {
    ...
    key: string;
    solver: CertManagerIoV1beta1.SolverSpec;
    token: string;
...
export function toChallenge(input: c.JSONValue): Challenge & c.ApiKind {
  ...
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "acme.cert-manager.io/v1beta1", "Challenge"),
...
export function fromChallenge(input: Challenge): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "acme.cert-manager.io/v1beta1", "Challenge"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
    spec: input.spec != null ? {
      ...input.spec,
      solver: input.spec.solver != null ? CertManagerIoV1beta1.fromSolverSpec(input.spec.solver) : undefined,
    } : undefined,
  }}
export function toChallenge_spec(input: c.JSONValue) {
  ...
  return {
    ...
    solver: CertManagerIoV1beta1.toSolverSpec(obj["solver"]),
...
export function toChallengeList(input: c.JSONValue): ChallengeList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "acme.cert-manager.io/v1beta1", "ChallengeList"),
...
export function toOrder(input: c.JSONValue): Order & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "acme.cert-manager.io/v1beta1", "Order"),
    metadata: MetaV1.toObjectMeta(obj["metadata"]),
...
export function fromOrder(input: Order): c.JSONValue {
  return {
    ...c.assertOrAddApiVersionAndKind(input, "acme.cert-manager.io/v1beta1", "Order"),
    ...input,
    metadata: input.metadata != null ? MetaV1.fromObjectMeta(input.metadata) : undefined,
...
export function toOrderList(input: c.JSONValue): OrderList & c.ApiKind {
  const obj = c.checkObj(input);
  return {
    ...c.assertOrAddApiVersionAndKind(obj, "acme.cert-manager.io/v1beta1", "OrderList"),
    metadata: MetaV1.toListMeta(obj.metadata),
